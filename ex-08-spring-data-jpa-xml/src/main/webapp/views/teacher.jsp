...
setTimeout(function () {
  document.getElementById('my-info').remove();
}, milliseconds);
</script>
	...
	<div class="container mt-4">
		...
		<form class="row">
			<div class="col-auto col-sm-3">
				...
				<input class="form-control" type="text" placeholder="Name Here" name="name" />
			</div>
			<div class="col-auto col-sm-3">
				<label class="form-label">Search Phone : </label>
				<input class="form-control" type="text" placeholder="Phone Here" name="phone" />
			</div>
		...
		<div class="mt-4">
			...
			<c:choose>
				...
				<c:otherwise>
					<div class="alert alert-danger" id="my-info">There is no data.</div>
				</c:otherwise>
